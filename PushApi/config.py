...
# Coveo constants
coveo_push_environment = 'push' + 'dev' if use_dev_environment else ''
coveo_platform_url = 'platform' + 'dev' if use_dev_environment else ''
...
coveo_document_batch_api_url = 'https://{pushEnv}.cloud.coveo.com/v1/organizations/{organizationId}/sources/{sourceId}/'  # TODO Complete the URL.
coveo_permission_batch_api_url = 'http://{pushEnv}.cloud.coveo.com/v1/organizations/{organizationId}/'   # TODO Complete the URL.
coveo_security_provider_api_url = 'https://{platformEnv}.cloud.coveo.com/rest/organizations/{organizationId}/'  # TODO Complete the URL.
coveo_mapped_identity_api_url = 'https://{pushEnv}.cloud.coveo.com/v1/organizations/{organizationId}/'  # TODO Complete the URL.
...
coveo_file_container_url = 'https://{pushEnv}.cloud.coveo.com/v1/organizations/{organizationId}/'  # TODO Complete the URL.
